...
(* **** *)
procedure BX_CPU_C.INC_ERX(I:PBxInstruction_tag);
var
  erx:Bit32u;
begin
  Inc(gen_reg[i^.b1 and $07].erx);
  erx := gen_reg[i^.b1 and $07].erx;
  SET_FLAGS_OSZAP_32(0, 0, erx, BX_INSTR_INC32);
end;

procedure BX_CPU_C.DEC_ERX(I:PBxInstruction_tag);
var
  erx:Bit32u;
begin
  Dec(gen_reg[i^.b1 and $07].erx);
  erx := gen_reg[i^.b1 and $07].erx;
  SET_FLAGS_OSZAP_32(0, 0, erx, BX_INSTR_DEC32);
end;

procedure BX_CPU_C.ADD_GdEd(I:PBxInstruction_tag);
var
...
procedure BX_CPU_C.ADD_EAXId(I:PBxInstruction_tag);
var
    // for 32 bit operand size mode
    op1_32, op2_32, sum_32:Bit32u;
begin
...
procedure BX_CPU_C.ADC_EdGd(I:PBxInstruction_tag);
var
  temp_CF:Bool;
    // for 32 bit operand size mode
...
procedure BX_CPU_C.ADC_EAXId(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32:Bit32u;
begin
...
procedure BX_CPU_C.SBB_EdGd(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
...
procedure BX_CPU_C.SBB_GdEd(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
...
procedure BX_CPU_C.SBB_EAXId(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
...
procedure BX_CPU_C.SBB_EdId(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
...
procedure BX_CPU_C.SUB_EdGd(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
...
procedure BX_CPU_C.SUB_GdEd(I:PBxInstruction_tag);
var
  op1_32, op2_32, sum_32, diff_32:Bit32u;
begin
  // op1_32 is a register, i->rm_addr is an index of a register
...
procedure BX_CPU_C.ADD_EdGd(I:PBxInstruction_tag);
var
  // for 32 bit operand size mode
  op2_32, op1_32, sum_32:Bit32u;
begin
...
procedure BX_CPU_C.CMPXCHG8B(I:PBxInstruction_tag);
var
  op1_64_lo, op1_64_hi, diff:Bit32u;
begin
{$if (BX_CPU_LEVEL >= 5) or (BX_CPU_LEVEL_HACKED >= 5)}
...
//     SET_FLAGS_OSZAPC_32(EAX, op1_32, diff_32, BX_INSTR_CMP32);
    ...
    if (diff = 0) then begin  // if accumulator = dest
      // ZF := 1
      set_ZF(1);
      // dest <-- src
...
procedure BX_CPU_C.CMP_EdId(I:PBxInstruction_tag);
var
...
procedure BX_CPU_C.NEG_Ed(I:PBxInstruction_tag);
var
...
procedure BX_CPU_C.INC_Ed(I:PBxInstruction_tag);
var
  op1_32:Bit32u;
begin
...
procedure BX_CPU_C.DEC_Ed(I:PBxInstruction_tag);
var
  op1_32:Bit32u;
begin
...
procedure BX_CPU_C.ADC_GdEd(I:PBxInstruction_tag);
var
  temp_CF:Bool;
  op1_32, op2_32, sum_32:Bit32u;
begin
...
procedure BX_CPU_C.CMPXCHG_EdGd(I:PBxInstruction_tag);
var
  op2_32, op1_32, diff_32:Bit32u;
begin
{$if (BX_CPU_LEVEL >= 4) or (BX_CPU_LEVEL_HACKED >= 4)}
    ...
    if (diff_32 = 0) then begin  // if accumulator = dest
      // ZF := 1
      set_ZF(1);
      // dest <-- src
      op2_32 := BX_READ_32BIT_REG(i^.nnn);
